...
(function(tinymce) {
	...
	tinymce.create('tinymce.dom.DOMUtils', {
		...
		split : function(pe, e, re) {
			...
			//   <p>text 1<span><strong>CHOP</strong></span>text 2</p>
			// would produce:
			//   <p>text 1<span></span></p><strong>CHOP</strong><p><span></span>text 2</p>
			// this function will then trim of empty edges and produce:
			//   <p>text 1</p><strong>CHOP</strong><p>text 2</p>
			function trim(node) {
	...
	tinymce.Formatter = function(ed) {
				...
				each(newWrappers, function(node) {
					...
					if (format.inline || format.wrapper) {
						...
						each(formatList, function(format) {
							...
							// this: <span style="color:red"><strong><span style="color:red; font-size:10px">text</span></strong></span>
							// will become: <span style="color:red"><strong><span style="font-size:10px">text</span></strong></span>
						...
						// Merge next and previous siblings if they are similar <strong>text</strong><strong>text</strong> becomes <strong>texttext</strong>
		...
		function remove(name, vars, node) {
			...
			if (!selection.isCollapsed() || !format.inline || dom.select('td.mceSelected,th.mceSelected').length) {
				...
				// Check if start element still has formatting then we are at: "<strong>text|</strong>text" and need to move the start into the next text node
		...
		function expandRng(rng, format, remove) {
			...
			// Example * becomes !: !<p><strong><i>*text</i><i>text*</i></strong></p>!
		...
		function removeFormat(format, vars, node, compare_node) {
			...
			// Remove the inline child if it's empty for example <strong> or <span>
